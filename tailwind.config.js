...
export default {
  ...{
  "content": [
    "/app/sandbox-data/workspace/frontend/index.html",
    "/app/sandbox-data/workspace/frontend/*.{ts,tsx}",
    "/app/sandbox-data/workspace/frontend/!(node_modules)/**/*.{ts,tsx}"
  ],
  "darkMode": "class",
  "theme": {
    "extend": {
      ...
      "fontFamily": {
        ...
        "mono": [
          "var(--font-mono, 'JetBrains Mono', SFMono-Regular, Consolas, monospace)"
        ]
      },
      "borderColor": {
